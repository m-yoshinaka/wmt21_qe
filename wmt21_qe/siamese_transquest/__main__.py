...
from wmt21_qe.siamese_transquest.run import run_siamesetransquest
from wmt21_qe.siamese_transquest.config import (
    SEED, SUBMISSION_FILE, MODEL_TYPE, MODEL_NAME, siamese_config
)
...
def main():
    ...
    logger.info('Start!')
    # Train/test model
    train_df_list, dev_df_list, test_df_list = run_siamesetransquest(
    ...
    save_results(
        ...
        output_dir, SUBMISSION_FILE, 'STransQuest-m', save_dev, logger
    )
